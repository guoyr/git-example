...
variables jobModCounts = [x \in 1..N |-> 0], savedModCounts = [x \in 1..N |-> 0], availableJobs = 0;
...
Init == (* Global variables *)
        /\ jobModCounts = [x \in 1..N |-> 0]
        /\ savedModCounts = [x \in 1..N |-> 0]
        /\ availableJobs = 0
...
\* Last modified Fri Oct 25 08:33:47 EDT 2019 by guo
