...
Init == (* Global variables *)
        ...
        /\ availableJobs = 0
        /\ pc = [self \in ProcSet |-> CASE self \in 1..3 -> "p1"
                                        [] self \in 4..5 -> "r0"]
...
Next == (\E self \in 1..3: producer(self))
...
\* Last modified Fri Oct 25 07:20:53 EDT 2019 by guo
